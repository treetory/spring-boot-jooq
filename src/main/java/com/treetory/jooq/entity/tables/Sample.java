 ...
 */
package com.treetory.jooq.entity.tables;


import com.treetory.jooq.entity.Indexes;
import com.treetory.jooq.entity.Keys;
...
public class Sample extends TableImpl<SampleRecord> {
    ...
    private static final long serialVersionUID = 1187086424;
    ...
    /**
     * The column <code>test.SAMPLE.id</code>.
     */
    public final TableField<SampleRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>test.SAMPLE.model</code>.
     */
    public final TableField<SampleRecord, String> MODEL = createField("model", org.jooq.impl.SQLDataType.VARCHAR(4000).nullable(false), this, "");

    /**
     * The column <code>test.SAMPLE.price</code>.
     */
    public final TableField<SampleRecord, BigDecimal> PRICE = createField("price", org.jooq.impl.SQLDataType.DECIMAL(20, 3).nullable(false), this, "");
